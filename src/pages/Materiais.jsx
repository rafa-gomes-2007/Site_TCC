  ...
  return (
    ...
    <hr className='border-t-2 border-black'/>
        <section className='flex items-center justify-center flex flex-col space-x-4 text-justify mx-40'>
            ...
            <div className='flex space-x-4 grid grid-cols-2 gap-40 p-4'>  
                <div className='bg-fundo_texto h-24 rounded-lg ml-18 mt-20 text-center py-6 px-8'>Um display de cristal líquido, acrônimo de LCD, é um painel fino usado para exibir informações por via eletrônica, como texto, imagens e vídeos.    
                </div>
