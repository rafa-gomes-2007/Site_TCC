...
function Materiais() {
  return (
    <div className="flex flex-col bg-cinza-back items-center justify-center">
        <h1 className='text-[164px] pt-7 font-Questrial max-lg:text-[70px]'>MATERIAIS</h1>
        <p className='text-center mx-[10px] pt-3 pb-20 text-[32px] font-Questrial max-lg:text-[20px]'>Quais materiais foram utilizados na composição do D.A.R.P?</p>

        <section className='flex-col items-center justify-center text-justify mx-40 w-full'>
            <h2 className='flex justify-center text-[50px] pt-10 mb-24 Roboto-Flex max-lg:text-[40px]'>ARDUÍNO UNO</h2>
            ...
            <h3 className='flex justify-center text-[45px] pb-8 font-Questrial max-lg:text-[38px]'>R$47,40</h3>
        </section>  
        ...
        <section className='flex-col items-center justify-center text-justify mx-40 w-full'> 
            ...
            <h3 className='flex justify-center text-[45px] pt-8 font-Questrial max-lg:text-[38px]'>R$44,56</h3>
        </section>

        <hr className='bg-[#D9D9D9] mt-[100px] mx-[120px] h-[8px] w-11/12'/>

        <section className='flex-col items-center justify-center text-justify mx-40 w-full'>
            <h2 className=' flex justify-center text-[50px] pt-10 mb-24 Roboto-Flex max-lg:text-[40px]'>MÓDULO MP3</h2>
            ...
            <h3 className='flex justify-center text-[45px] pt-8 font-Questrial max-lg:text-[38px]'>R$27,69</h3>
        </section>  
        ...
        <div className='flex-col items-center justify-center text-justify mx-40 w-full'>
            ...
            <h3 className='flex justify-center text-[45px] pt-8 pb-20 Questrial max-lg:text-[38px]'>R$75,91</h3>
        </div>
    </div>
