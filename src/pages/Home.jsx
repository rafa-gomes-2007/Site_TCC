  ...
  return (
    <main className="flex-col justify-center items-center mt-5">
      ...
      <div className="flex-col items-center mt-[80px]">
        <h2 className="text-[96px] text-center my-auto max-lg:text[65px]">Objetivo</h2>
        <p className="text-[32px] text-center mt-[15px] max-lg:[16px]">Quais são o nosso objetivo com esse produto?</p>
        <section className="flex columns-3 justify-center mt-[100px] max-lg:flex-col max-lg:columns-1 max-lg:space-y-10">
      ...
      <section className="flex-col items-center mt-[50px]">
        <h2 className="text-[96px] text-center my-auto max-lg:text-[65px]">Público Alvo</h2>
        <p className="text-[32px] text-center mb-[80px] max-lg:text-[16px]">A quem pretendemos entregar nosso produto final</p>
        <p className="text-[32px] bg-[#D9D9D9] mb-[100px] px-[20px] py-[20px] mx-[100px] rounded-lg max-lg:text-[14px]">Este público inclui pessoas de todas as idades que sofrem de transtornos de ansiedade, ataques de pânico, fobias, estresse crônico e outras condições relacionadas. Essas pessoas muitas vezes enfrentam dificuldades em lidar com situações cotidianas, relacionamentos pessoais e profissionais, e podem sentir-se sobrecarregadas pela intensidade de suas emoções.</p>
      </section>

      <hr className='bg-[#D9D9D9] mt-[100px] mx-[120px] h-[8px]'/>

      <section className="flex-col items-center mt-[50px]">
        <h2 className="text-[96px] text-center my-auto max-lg:text-[65px]">Diferencial</h2>
        <p className="text-[32px] text-center mb-[80px] max-lg:text-[16px]">Pontos que podemos oferecer a mais </p>
        <ul className="flex-col columns-1 items-center text-center mx-auto justify-center">
